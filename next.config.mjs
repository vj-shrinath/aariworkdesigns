...
const nextConfig = {
  ...
  async headers() {
    return [{ source: '/(.*)', headers: [
      ...
      { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https://cdn.sanity.io https://m.media-amazon.com https://images.unsplash.com https://image.pollinations.ai; connect-src 'self' https://test.payu.in https://secure.payu.in https://*.payu.in https://*.supabase.co https://*.sanity.io; frame-src 'self' https://test.payu.in https://secure.payu.in https://*.payu.in; object-src 'none'; base-uri 'self'; form-action 'self' mailto: https://test.payu.in https://secure.payu.in https://*.payu.in; upgrade-insecure-requests" },
    ]}];
  },
  images: {
