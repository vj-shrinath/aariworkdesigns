...
const sections: ComplianceSection[] = [
  ...
  { heading: "Cookies and advertising", paragraphs: ["We use essential cookies to remember language and authentication preferences.", "We use third-party vendors, including Google, who use cookies to serve ads based on a user's prior visits to this website or other websites.", "Google's use of advertising cookies enables it and its partners to serve ads to our users based on their visit to our sites and/or other sites on the Internet.", "Users may opt out of personalized advertising by visiting Google Ads Settings (https://www.google.com/settings/ads) or www.aboutads.info."] },
